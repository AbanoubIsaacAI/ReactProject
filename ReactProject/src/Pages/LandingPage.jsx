  ...
  const features = [
    {
      ...
      description:
        "Sleek aesthetics meet functional elegance in our thoughtfully crafted products. From minimalist to bold styles, our designs blend beauty with purpose to elevate your everyday experience.",
    },
    {
      title: "Latest Technology",
      description:
        "Stay ahead with cutting-edge innovations and modern solutions. We continuously integrate the newest advancements to bring you smart, future-ready products that simplify your life.",
    },
    {
      title: "User Friendly",
      description:
        "Intuitive interfaces and effortless functionality are at our core. We prioritize seamless experiences with products designed to be accessible and enjoyable for everyone.",
    },
    {
      title: "High Quality",
      description:
        "Our products are built to last, using premium materials and precise engineering to ensure top-notch performance and durability you can count on.",
    },
  ];
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-sm md:text-base mt-4 text-gray-300 text-center md:text-left">
                Welcome to Electronica your trusted online store for the latest
                electronics.
              </p>
                  ...
                  <>
                    ...
                    <Link to="/signup">
                      <motion.button
                        whileHover={{
                          scale: 1.05,
                          boxShadow: "0 5px 15px rgba(224, 4, 93, 0.6)",
                        }}
                        whileTap={{ scale: 0.95 }}
