...
//                 <>
//                 <li>
//                     <span className="px-4 py-2 text-gray-700">Hello, {currentUser.username}</span>
//                   </li>
...
//               <div tabIndex={0} className="card card-compact dropdown-content bg-base-100 z-10 mt-3 w-96 shadow-lg">
//                 <div className="card-body max-h-96 overflow-y-auto space-y-4">
//                   {wishlist.length === 0 ? (
//                     <div className="flex flex-col items-center justify-center h-60 text-center text-gray-400">
//                       <svg
...
//                       />
//                       <Link to={`/shop`} className="w-full">
//                         <button className="btn w-50 text-white" style={{ backgroundColor: "#FA8232" }}>
//                           Show Products
//                         </button>
//                       </Link>
//                     </div>
...
//                       </span>
//                       {wishlist.map((product) => (
//                         <div className="flex items-center gap-4 p-3 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition" key={product.id}>
//                           <img src={product.image} alt={product.title} className="w-20 h-20 object-cover rounded-md" />
//                           <div className="flex flex-col justify-between flex-grow">
//                             <h6 className="font-semibold text-sm line-clamp-2">{product.title}</h6>
//                             <p className="text-orange-500 font-medium text-sm mt-1">Price: {product.finalPrice}$</p>
//                             <div className="flex gap-2 mt-2">
//                               <button
//                                 className="btn btn-sm bg-blue-500 text-white hover:bg-blue-600"
...
//                         />
//                         <Link to={`/shop`} className="w-full">
//                           <button className="btn w-full mt-2 text-white" style={{ backgroundColor: "#FA8232" }}>
//                             Start Shopping
//                           </button>
//                         </Link>
//                       </>
